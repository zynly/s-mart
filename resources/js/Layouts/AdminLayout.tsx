...
const NAV_ITEMS = [
  ...
  { label: 'Stock Opname', href: '/admin/opnames' },
  { label: 'Transfer Stok', href: '/admin/transfers' },
  { label: 'Penyesuaian Stok', href: '/admin/stock-adjustments' },
  { label: 'Sesi Kasir', href: '/admin/cashier-session' },
  { label: 'Kas', href: '/admin/cash' },
  { label: 'Bagan Akun', href: '/admin/accounts' },
  { label: 'Jurnal', href: '/admin/journals' },
  { label: 'Buku Besar', href: '/admin/ledger' },
  { label: 'Neraca Saldo', href: '/admin/trial-balance' },
