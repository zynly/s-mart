...
return [
    ...
    */
    ...
    'connections' => [
        ...
        // Temuan audit performa (Phase C, CRITICAL): koneksi PDO
        // TERPISAH (bukan alias) ke database yang SAMA, dipakai HANYA
        // oleh ReferenceGenerator. `DB::transaction()` di Laravel
        // nge-track level transaksi PER OBJEK KONEKSI — kalau
        // ReferenceGenerator pakai koneksi 'mysql' yang sama seperti
        // pemanggilnya (mis. SaleService::complete()), transaksinya
        // cuma jadi SAVEPOINT bersarang dan row lock `reference_counters`
        // tertahan sampai SELURUH transaksi checkout selesai (bisa
        // ratusan ms) — SEMUA kasir antre satu per satu di titik ini
        ...
        'reference_counters' => [
            ...
            'password' => env('DB_PASSWORD', ''),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => env('DB_CONNECTION') === 'pgsql' ? env('DB_PGSQL_CHARSET', 'utf8') : env('DB_CHARSET', 'utf8mb4'),
            'collation' => env('DB_COLLATION', 'utf8mb4_unicode_ci'),
            'prefix' => '',
            'prefix_indexes' => true,
            'strict' => true,
